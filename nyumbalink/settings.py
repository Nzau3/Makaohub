"""
Django settings for makaohub project.
...
SECRET_KEY = "django-insecure-9a4-6o_n=^c+538r(u1zpj!xps4@nh#uqp_&8i4_=6cdrz7q+7"
...
if not DEBUG:
    ...
    # If deployed behind a proxy/load balancer terminating SSL
